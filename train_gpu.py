    ...
    for network in networks:
        if network == "fully_connected":
            ...
            if network != "nature_cnn":
                ...
                replace.replace_nature_visual_encoder("D:/miniconda/envs/mlagents-gpu/Lib/site-packages/mlagents/trainers/torch_entities/encoders.py", "./Encoders/" + network + ".py")
